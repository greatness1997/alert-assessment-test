        ...
        return (
            <>
                ...
                <View style={styles.container}>
                    ...
                    <Text style={{ color: "black", fontWeight: "500", fontSize: s(13), textAlign: "center", paddingLeft: s(30), paddingRight: s(30) }}>Sorry we can't reach SpoutPay Server, Check your Internet Connection</Text>
                </View>
            </>
        );
